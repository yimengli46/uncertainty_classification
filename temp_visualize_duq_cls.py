...
base_folder = 'visualization/prop_cls_GP'
saved_folder = '{}/obj_sseg_{}/{}/{}'.format(base_folder, style, rep_style, dataset)
cls_model_dir = 'trained_model/prop_cls_GP/{}/{}'.format(style, rep_style)
...
cls_head.load_state_dict(torch.load('{}/{}_classifier_0.1.pth'.format(cls_model_dir, style)))
cls_head.eval()
