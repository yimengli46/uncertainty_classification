...
class CityscapesClassificationDataset(data.Dataset):
	def __init__(self, dataset_dir, split='train', batch_size=3, rep_style='both', mask_dir=None):
	...
	def __getitem__(self, i):
		...
		sseg_mask = torch.tensor(mask_and_label['mask'][index])
		class_label = torch.tensor(mask_and_label['class'][index])
