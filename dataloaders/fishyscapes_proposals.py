...
class FishyscapesProposalsDataset(data.Dataset):
	def __init__(self, dataset_dir, rep_style='both'):
		...
		self.proposal_folder = '/home/yimeng/ARGO_scratch/detectron2/my_projects/Bayesian_MaskRCNN/generated_proposals_whole/fishyscapes'
		self.mask_ft_folder  = '/home/yimeng/ARGO_scratch/detectron2/my_projects/Bayesian_MaskRCNN/whole_features_cityscapes_dropout/fishyscapes'
		self.sseg_ft_folder  = '/home/yimeng/ARGO_datasets/Fishyscapes_Static/deeplab_ft_8_classes'
