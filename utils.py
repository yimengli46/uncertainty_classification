...
sseg_color_list_8 = [(128, 64, 128), ( 70, 70, 70), (153, 153, 153), (107, 142, 35), (70, 130, 180), (220, 20, 60),
	(0, 0, 142), (0, 80, 100)]
sseg_color_list_ignore_person = [(128, 64, 128), ( 70, 70, 70), (153, 153, 153), (107, 142, 35), (70, 130, 180),
	(0, 0, 142), (0, 80, 100), (0, 0, 230)]
	
def apply_color_map(image_array, num_classes=8):
	if num_classes == 19:
		sseg_color_list = sseg_color_list_19
	elif num_classes == 8:
		sseg_color_list = sseg_color_list_ignore_person
