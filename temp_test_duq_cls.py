...
with torch.no_grad():
	for i in img_id_list:
		...
		for j in range(num_proposals):
			...
			try:
				mask_npy = np.load('/home/yimeng/work/uncertainty_classification_all_props/gen_object_mask/obj_sseg_duq/SSeg/{}/img_{}_proposal_{}_mask.npy'.format(dataset, i, j), allow_pickle=True).item()
			except:
